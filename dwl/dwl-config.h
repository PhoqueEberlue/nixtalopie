...
static const Key keys[] = {
	...
	{ MODKEY,                    XKB_KEY_l,          spawn,            SHCMD("pkill dwlb; dwlb & disown") },
	{ MODKEY,                    XKB_KEY_Up,         spawn,            SHCMD("brightnessctl set 10%+") },
	{ MODKEY,                    XKB_KEY_Down,       spawn,            SHCMD("brightnessctl set 10%-") },
	{ MODKEY,                    XKB_KEY_c,          spawn,            SHCMD("grim -g \"$(slurp)\"") },
	{ MODKEY,                    XKB_KEY_t,          focusstack,       {.i = +1} },
	{ MODKEY,                    XKB_KEY_n,          focusstack,       {.i = -1} },
	/*{ MODKEY,                    XKB_KEY_w,          incnmaster,       {.i = +1} },
	{ MODKEY,                    XKB_KEY_v,          incnmaster,       {.i = -1} },*/
	...
	TAGKEYS(          XKB_KEY_u, XKB_KEY_U,                            3),
	TAGKEYS(          XKB_KEY_i, XKB_KEY_I,                            4),
	TAGKEYS(          XKB_KEY_dead_acute, XKB_KEY_dead_diaeresis,      5),
	TAGKEYS(          XKB_KEY_comma, XKB_KEY_less,                     6),
	TAGKEYS(          XKB_KEY_period, XKB_KEY_greater,                 7),
	TAGKEYS(          XKB_KEY_p, XKB_KEY_P,                            8),
	TAGKEYS(          XKB_KEY_y, XKB_KEY_Y,                            9),
 	{ MODKEY|WLR_MODIFIER_CTRL,  XKB_KEY_r,          restartdwl,       {0} },
